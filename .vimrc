...
noremap <C-F> :Clap lines<CR>
noremap <ESC>[65;5u :Clap grep<CR> 
noremap <leader>f :Clap files<CR>
noremap <leader>m :Clap maps<CR>
...
"noremap <ESC>[65;5u :<C-U><C-R>=printf("Leaderf! rg -e %s ", expand("<cword>"))<CR>
...
"set previewpopup=height:60,width:60
